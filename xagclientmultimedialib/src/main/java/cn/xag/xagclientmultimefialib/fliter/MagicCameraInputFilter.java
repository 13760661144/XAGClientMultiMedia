package cn.xag.xagclientmultimefialib.fliter;
...
import cn.xag.xagclientmultimefialib.utils.OpenGlUtils;
...
public class MagicCameraInputFilter extends GPUImageFilter {
    ...
    public MagicCameraInputFilter(Context context){
        super(OpenGlUtils.readShaderFromRawResource(R.raw.default_vertex,context) ,
                OpenGlUtils.readShaderFromRawResource(R.raw.default_fragment,context));
    }
