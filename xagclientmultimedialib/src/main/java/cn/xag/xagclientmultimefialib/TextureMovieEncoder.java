...
import cn.xag.xagclientmultimefialib.fliter.MagicCameraInputFilter;
...
public class TextureMovieEncoder implements Runnable {
    ...
    public void run() {
        ...
        Looper.prepare();
        synchronized (mReadyFence) {
            mHandler = new EncoderHandler(this,mContext);
            mReady = true;
            mReadyFence.notify();
        }
        Looper.loop();
    ...
    private static class EncoderHandler extends Handler {
        ...
        public EncoderHandler(TextureMovieEncoder encoder,Context context) {
        ...
        public void handleMessage(Message inputMessage) {
            ...
            switch (what) {
                case MSG_START_RECORDING:
                    encoder.handleStartRecording((EncoderConfig) obj,mContext);
                    break;
                ...
                case MSG_UPDATE_SHARED_CONTEXT:
                    encoder.handleUpdateSharedContext((EGLContext) inputMessage.obj,mContext);
                    break;
                case MSG_QUIT:
     ...
     * Starts recording.
     */
    private void handleStartRecording(EncoderConfig config,Context context) {
     ...
     */
    private void handleUpdateSharedContext(EGLContext newSharedContext,Context context) {
        ...
        mInput = new MagicCameraInputFilter(context);
        mInput.init();
        filter = null;
        if (filter != null) {
            filter.init();
